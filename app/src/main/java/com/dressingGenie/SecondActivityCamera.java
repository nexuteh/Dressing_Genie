...
public class SecondActivityCamera extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Step 3: Take a Side Full Body Picture");
        height = getIntent().getExtras().getString("Height","defaultKey");
        if (height==null) throw new AssertionError("Invalid Bitmap");
        ...
        return Fotoapparat
                ...
                .cameraErrorCallback(new CameraErrorListener() {
                    ...
                    public void onError(@NotNull CameraException e) {
                        Toast.makeText(SecondActivityCamera.this, e.toString(), Toast.LENGTH_LONG).show();
                    }
                })
                .build();
    }
                ...
                .whenDone(new WhenDoneListener<BitmapPhoto>() {
                    ...
                    public void whenDone(@Nullable BitmapPhoto bitmapPhoto) {
                        try {
                            ...
                            saveBitmap(RotateBitmap(bitmapPhoto.bitmap), "secondImage");
                            Intent myIntent = new Intent(SecondActivityCamera.this, ThirdActivityCamera.class);
                            myIntent.putExtra("Height",height);
                            SecondActivityCamera.this.startActivity(myIntent);
