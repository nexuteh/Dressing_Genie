...
public class FirstActivityCamera extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Step 2: Take a Front Full Body Picture");
        ...
        return Fotoapparat
                ...
                .cameraErrorCallback(new CameraErrorListener() {
                    ...
                    public void onError(@NotNull CameraException e) {
                        Toast.makeText(FirstActivityCamera.this, e.toString(), Toast.LENGTH_LONG).show();
                    }
                })
                .build();
    }
                ...
                .whenDone(new WhenDoneListener<BitmapPhoto>() {
                    ...
                    public void whenDone(@Nullable BitmapPhoto bitmapPhoto) {
                        try {
                            ...
                            saveBitmap(RotateBitmap(bitmapPhoto.bitmap), "firstImage");
                            Intent myIntent = new Intent(FirstActivityCamera.this, SecondActivityCamera.class);
                            myIntent.putExtra("Height",height);
                            FirstActivityCamera.this.startActivity(myIntent);
